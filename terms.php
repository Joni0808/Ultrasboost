        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center header-content" data-aos="fade-up">
                    ...
                    <p class="mb-5 term-desc"><strong>Definitions</strong></p>
                    <p class="mb-5 term-desc">- "Service" refers to the Discord server boosts and any other related services we offer.</p>
                    <p class="mb-5 term-desc">- "User" or "you" refers to any individual or entity that accesses or uses our Services.</p>
                    <p class="mb-5 term-desc">- "We," "us," or "our" refers to Ultras Boosts.</p>
                </div>
            </div>
        </div>
    </header>
